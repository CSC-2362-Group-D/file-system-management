...
app.post('/api/login', async (req, res) => {
  ...
  if (authResult.success) {
    ...
    const instructionsFilePath = path.join(userHomeDir, '/uploads/','instructions.txt');
    const instructionsContent = "General information about this project:\n\n...";
    ...
    try {
      ...
      if (!fs.existsSync(userHomeDir)) {
        ...
        fs.writeFileSync(instructionsFilePath, instructionsContent, { flag: 'wx' });
      }
      // Generate JWT token
